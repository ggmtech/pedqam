...
#bibliography: "../pedqam/GKBibMaster.bib" #   , "skeleton.bib"
bibliography: "../gkbookdown//book.bib" #   , "skeleton.bib"
...
We will use the built-in iris dataset as an example. This dataset consists in Petal and Sepal width and length measurements for three iris species. Table `r run_reference("summaryTable")` shows summary statistics.
...
```{r myimage, eval = TRUE, echo = FALSE, results = 'asis'}
