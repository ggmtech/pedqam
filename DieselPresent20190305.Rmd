---
title: "Diesel Loco Performance"
subtitle: " Loco failures"
author: "Diesel Loco Wing $^1$"
date: '`r Sys.Date()`'
output:
  revealjs::revealjs_presentation:
    ...
    reveal_options:
      chalkboard:
        theme: "blood"  #chalkboard  # "default", "simple", "sky", "beige", "serif", "solarized", "blood",                    "moon", "night", "black", "league" or "white")
        toggleNotesButton: yes
      menu:
        numbers: yes
      slideNumber: true
      previewLinks: true
    self_contained: false  # else file must be in dir
    toc: yes
    highlight: haddock  #  espresso  ,  pygments
    center: true
    fig_width: 20
    fig_height: 10
    fig_caption: true
    number_sections: true
    transition: "none" #fade # "default", "fade", "slide", "convex", "concave", "zoom" or "none".
    background_transition: none #zoom # "default", "fade", "slide", "convex", "concave", "zoom" or "none".
...
# The Diesel Organisaiton Presentation

## Diesel Loco Orgnisation {data-background=#ff00ff} 

## Diesel Loco 3 Orgnisation {data-background=red} 

<center>

![your image caption](WDG4Gphoto.jpg)

</center>

## The HQ establishment

  : The HQ Diesel Organisation 

| Post establishment | No in HQ |
|:------------------- | ------: |
| CMPE(Diesel) |  1 |
| DyCME(Diesel) | 1 | 
| AME/Diesel  | 1 |
...
| SLI       | 1 |
| SSE Drg | 3 |
| Other supporting from shed, reengagement | 4 |
| Mins   | 3  |
| Total  | 14 |

## <span style="color:red"> Maintainance of over <span  style="color:blue" > 600 Motive Powers </span>

  : <span  style="color:blue" >The Locos Maintained in Diesel Shed  </span  >

| Type        | Units |  Remarks|
|-------------|------:|------:|
| Mainline Diesel Locos | 540 | second highest, First is SCR with 580 |
| <span style="color:red"> Electrical Locos </span>| 15 | At TKD = WAP1 , LDH = WAG7  |
| Nerrow Gague Locos | 34 | 6 under manufacture at Parel |
| Rail Motor Cars | 4 | ICF to supply train set |
| Total | 600 | Highest in IR |

<!--- 
Roses are <span style="color:red">red</span>,  --->
<span  style="color:blue" >     mycoloured spl text blue     </span  >


# Important obligations of Diesel Organisation


: Key index of Diesel Organisation

| Type        | Units |  Remarks|
|-------------|------:|------:|
| Mail/Express Links | 230 | Highest in IR, Next is SCR with 200 |
| Goods Loco Outage | 15    |          |
| Electric Loco capacity building |   |     |
| Total      | 600   |     Highest in IR |
...
## Direct PL /100ML/Month    Apr-Sept- Feb 2019
...
1. Support from DLW
    1.1 Poor Quality of new locos
    1.2 No support from poor quality items
    1.3 DLW ditching the sheds

2. Support from DMW
    1.1 Poor Quality of rebuilt locos
    1.2 No support from poor quality items. Locos
    1.3 DMW ditching the sheds
...
### Advantage of the project (remains static ?)
...
### 1st of its type JV ... Joint Venture with 26% IR share ~ Rs. 1300 Cr. plus investment
...
# Infrastructure  {data-background-iframe="www.google.com" }

Infrastructure to be setup under contract
