---
title: Quality System in RDSO for Mechanical Items
subtitle: Quality Assurance (Mech.) Directorate, RDSO
author: Gopal Kumar
institute: RDSO, Lucknow, UP
...
# NAIR Presentation background {data-background="gopalkumar.jpg"}

Case studies
Go for rmd file 
NAIR
RDSO Vendor Development process
Railway expectations complaints
Management expectations : Online line , without harassment, ease of doing business
Check sheets - critical items of check not there (EM pads)
Six sigma practices
WTC   , Online inspection futility , 
Expenditure in infrastructure but not guarantee of Purchase orders
Actions taken by RDSO
