...
```{r nosetup, include=FALSE,  echo=FALSE, message = FALSE, warning=TRUE, error= TRUE, tidy=FALSE, cache=TRUE}

# https://github.com/ismayc/thesisdown
# https://happygitwithr.com/big-picture.html#audience-and-pre-reqs
...
library("imager")
original = imager::load.image("peoples2.jpg")
d = dim(original)[1:2]
d

#fs::file_info("peoples2.jpg")$size
scale = max(d / 400)
...
# pad the other dimension with a white background

square_img = imager::pad(img, 
                         nPix = 400 - height(img), 
                         axes = "y", 
                         val = "white")
imager::save.image(square_img, file = "peoples2.jpg")
square_img
