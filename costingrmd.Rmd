...
```{r myimage, eval = TRUE, echo = FALSE, results = 'asis', message=FALSE, warning=FALSE, cache=FALSE, fig.height=1, fig.width=1}
...
```{r,  eval=TRUE, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE}
#fig.show='hold',
#library(officer)
