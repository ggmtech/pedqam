...
```{r getdatas, include=TRUE, eval=FALSE, echo=FALSE, message = FALSE, warning=FALSE, error= FALSE, tidy=FALSE, fig.width=7, fig.height=7 , cache=TRUE}
...
sheet = 1
empaddata1 <- read_sheet(  ss,   sheet = NULL,  
                           skip = 1, range = NULL,
...
```{r printable2, include=TRUE, eval=TRUE, echo=FALSE, message = FALSE, warning=TRUE, error= FALSE, tidy=FALSE, cache=TRUE, fig.width=7, fig.height=7}
...
```{r printable3, include=TRUE, eval=FALSE, echo=FALSE, warning=TRUE, error= FALSE, tidy=FALSE, cache=TRUE, fig.width=7, fig.height=7}
