...
address:
  - code: a
    address: Institute of Smoke and Magic, University of Sometown, Sometown, XY
  - code: b
    address: Department of Neat Tricks, Whereever State University, Someplace, MC
...
# Produce a pinp document  # was    output: pinp::pinp # but no tex?
output: 
  pinp::pinp:
    keep_tex: true
