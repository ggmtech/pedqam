...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% 2012 by Sven Hartenstein  mail@svenhartenstein.de
%% http://www.svenhartenstein.de
%%  small collection of LaTeX commands that I found useful when creating a
%% questionnaire. Feel free to copy and adjust any parts you like.
%% Most probably, you will want to change the commands, so that they
%% fit your taste.  suggestion to put \noindent  %% before \rule!
