% exam question paper
\title{exam questionnaire}
\documentclass[a4paper,10pt,BCOR10mm,oneside,headsepline]{article} %scrartcl}

%\usepackage[ngerman]{babel}
%\usepackage[utf8]{inputenc}

\usepackage{fontspec}
\newfontfamily\hindifont{Utsaah}[Script=Devanagari] % Use any Devanagari font on your system
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% 2012 by Sven Hartenstein  mail@svenhartenstein.de %% http://www.svenhartenstein.de
%% put \noindent  %% before \rule!
%% \Qq = Questionaire question. easy to globally change
...
%% \Qrating = create a rating scale with NUM steps, like 0--0--0--0--0.
\newcounter{qr}
\newcommand{\Qrating}[1]{\QO\forloop{qr}{1}{\value{qr} < #1}{---\QO}}


%% \Qline = setting the line thickness globally. Used both by direct call and by \Qlines.
...
%\begin{hindi} हिन्दी संस्करण ।    \end{hindi}
...
\QItem[b]{ \Qq{Beethoven} \Qtab{3cm}{horrible \Qrating{8} fantastic}}
