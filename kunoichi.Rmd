---
title: " परस्तुती:<br>  गुणवत्ता अास्वाशन   " #(य़ाँर्तिकी)  "
subtitle: " वर्ष २०१९-२०  के कार्य "
author: "गोपाल कुमार, <br> वरिस्ठ कार्यकारी निदेसक (गु० आ० या० )"
#"<br><br>Emi Tanaka &nbsp;`r  anicon::faa('twitter', animate='float', rtext='@statsgen')` "
date: "<br>`r Sys.Date()`"
output:
...
# "  गुणवत्ता अास्वाशन   "
# Ensuring Railway Operations Safety !!!
# Predecide specificatinos, verify the specification by Inspection

--
## Transperency, while ensuring technical requirements

--

<img src="img/blooms_taxonomy.png" width="40%">
...
```
This is within three back ticks
output:
  xaringan::moon_reader:
...
.column.bg-main3[ some text in smaller colomn
]
...
<img src="img/blooms_taxonomy.png" width="90%">
<!--- ![](images/lee_thin.png) --->
...
<img src="img/blooms_taxonomy.png" width="90%"> <br>
<img src="img/blooms_taxonomy.png" width="90%">
...
<img src="img/blooms_taxonomy.png" width="20%">
# This is .blade2
]]
...
.img-fill[  <img src="img/blooms_taxonomy.png" width="90%"> <!--- ![](bkgs/bg1.jpg) ---> ]
]]
...
.img-fill[ <!--- ![](bkgs/bg1.jpg) ---> <img src="img/blooms_taxonomy.png" width="10%"> ]
]]
.row.bg-main1[.content[
# Here we insert 
```{}
.row[.content.nopadding[
.img-fill[ <img src="img/blooms_taxonomy.png" width="10%"> <!---![](bkgs/bg1.jpg) ---> ]
]]
```
